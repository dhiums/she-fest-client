...
const ViewProgram = (props: Props) => {
  ...
  const [candidateProgrammes, setCandidateProgrammes] = React.useState<CandidateProgramme[]>(props.selected?.candidateProgramme as CandidateProgramme[])
                  ...
                  <div className="flex w-full gap-1">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        setCandidateProgrammes(props.selected?.candidateProgramme?.filter((cp) => {
                          return cp.candidate?.name?.toLowerCase().includes(name.toLowerCase()) || cp.candidate?.chestNO?.toLowerCase().includes(name.toLowerCase())
                        }
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        setCandidateProgrammes(props.selected?.candidateProgramme?.filter((cp) => {
                          return cp.candidate?.team?.zone?.name?.toLowerCase().includes(zone.toLowerCase())
                        }
                        ) as CandidateProgramme[])
                      }}
                    >
